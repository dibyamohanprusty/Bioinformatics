...
## plot the bars
means_barx = barplot(means, names.arg=c('A','B','C'),ylim=c(0,40), axis.lty=1, 
                   xlab="Experiments", ylab="Value (arbitrary units)", width=0.5,
		   xlim=c(0,10), space=1.0, col="grey",font.lab=1, 
		    main="Errors on bar plot", cex.lab=1.2, cex.axis=1.2, cex.names=1.2,
		    cex.main=1.2 )

## Plot the up and down arrows as error bars on the bars
arrows(means_barx, means+stderr, means_barx, means-stderr, angle=90, code=3, 
       length=0.06, col="blue")
...
plot(x,y, ylim=c(0,35), type="o", xlab="Concentration", ylab="Optical activity", 
